...
public class InitActModel extends BaseActModel {
    ...
    private Ad landrad;
    private DanmakuModel danmaku;
    private int isBeaut;
    private int simulator;
    private int monitorGetInto;
    private int monitorResident;
    ...
    public int getMonitorGetInto() {
        return monitorGetInto;
    }

    public void setMonitorGetInto(int monitorGetInto) {
        this.monitorGetInto = monitorGetInto;
    }

    public int getMonitorResident() {
        return monitorResident;
    }

    public void setMonitorResident(int monitorResident) {
        this.monitorResident = monitorResident;
    }

    public DanmakuModel getDanmaku() {
        return danmaku;
    }

    public void setDanmaku(DanmakuModel danmaku) {
        this.danmaku = danmaku;
    }

    public Ad getLandrad() {
        return landrad;
    }

    public void setLandrad(Ad landrad) {
        this.landrad = landrad;
    }
    ...
    public int getIsBeaut() {
        return isBeaut;
    }

    public void setIsBeaut(int isBeaut) {
        this.isBeaut = isBeaut;
    }
