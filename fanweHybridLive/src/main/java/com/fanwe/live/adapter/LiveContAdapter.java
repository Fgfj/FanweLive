...
//                break;
//        }
        binddefaultData(position + 3, convertView, parent, model);
    }
...
//    }
    ...
    private void binddefaultData(int position, View convertView, ViewGroup parent, App_ContModel model)
    {
        ...
        TextView tv_tip_ticket = get(R.id.tv_tip_ticket, convertView);
        ...
        if (!TextUtils.isEmpty(tipTicket))
        {
            tv_tip_ticket.setText(tipTicket);
        }
