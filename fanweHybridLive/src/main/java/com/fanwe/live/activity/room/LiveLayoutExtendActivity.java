...
import com.fanwe.auction.appview.room.RoomAuctionInfoCountdownView;
...
public class LiveLayoutExtendActivity extends LiveLayoutGameExtendActivity implements AuctionBusiness.AuctionBusinessListener, ShopBusiness.ShopBusinessListener
{
    ...
    protected ViewGroup fl_live_auction_countdown;//竞拍倒计时
    ...
    protected void initLayout(View view)
    {
        ...
        fl_live_auction_countdown = (ViewGroup) view.findViewById(R.id.fl_live_auction_countdown);
    ...
    protected void addLiveAuctionInfo(App_pai_user_get_videoActModel app_pai_user_get_videoActModel)
    {
        ...
        roomAuctionInfoCountdownView = new RoomAuctionInfoCountdownView(this);
